...
const FullSidebar = ({ showCollabsed }) => {
	...
	return (
		<>
			<aside className={`h-screen flex flex-col items-center overflow-hidden text-gray-700 bg-white rounded mr-5 ${locale === 'ar' && Style.aside}`}>
				...
				<div className="w-full px-2">
					<div className="flex flex-col items-center w-full mt-3 border-gray-300">
						<Link to={'/'} className={`flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300 ${pathname === '/' && 'bg-gray-300'}`}>
							...
							<span className="ml-2 text-sm font-medium">{t.fullsidebar.home}</span>
						</Link>
						<Link to={'/calender'} className={`flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300 ${pathname === '/calender' && 'bg-gray-300'}`}>
							...
							<span className="ml-2 text-sm font-medium">{t.fullsidebar.calender}</span>
						</Link>
					</div>
					<Link to={'/notifications'} className={`relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300 ${pathname === '/notifications' && 'bg-gray-300'}`}>
						...
						<span className="ml-2 text-sm font-medium">{t.fullsidebar.notifications}</span>
						<span className={`absolute top-0 ${locale === 'ar' ? 'right-0' : 'left-0'} w-2 h-2 mt-2 ml-2 bg-indigo-500 rounded-full`}></span>
					</Link>
					<Link to={'/settings/account'} className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300">
						...
						<span className="ml-2 text-sm font-medium">{t.fullsidebar.settings}</span>
					</Link>
				</div>
